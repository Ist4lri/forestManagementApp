...
urlpatterns = [
    ...
    path('accueil/<str:nom_foret>/incidentForm/', v_post_new_incident, name="incident_form"),
    path('accueil/<str:nom_foret>/formSubmitted/', v_form_submitted, name='formSubmitted'),
